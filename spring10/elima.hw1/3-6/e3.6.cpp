...
// Same method of solving 3-7 that Muldner uses, the only difference is that its paramaters to the constructors are different using pointers to points.

#include <iostream>
using namespace std;
#include "e3.6-point.h"
#include "e3.6-cube.h"
