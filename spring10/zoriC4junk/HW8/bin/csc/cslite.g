...
@init{ Element root_e = new Element("AST_IR");
...
: FOR  i=ID {id = i.getText();} L_PAREN f=NUM {first = f.getText();} COLON s=NUM {last = s.getText();} (COLON t=NUM {step = t.getText();})? R_PAREN b=block
